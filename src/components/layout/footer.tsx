...
export default function Footer() {
    ...
    return (
        <div className="border-t border-slate-200 dark:border-neutral-600 flex flex-col sm:flex-row items-center justify-between gap-6 mt-20 -mx-7 sm:-mx-8 lg:-mx-12 px-16 py-8">
            <nav>
