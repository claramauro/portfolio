...
export default function Carrousel({ images }: { images: string[] }) {
    ...
    return (
        <div className="relative mb-16">
            <div className="absolute z-40 -left-6 top-1/2 -translate-y-1/2" onClick={handlePreviousImg}>
                <button
                    type="button"
            ...
            <div className="overflow-hidden">
                <div className="flex transition-transform duration-500 ease-in-out" ref={carrouselContainer}>
                    {images.map((image, index) => (
                        <div className="relative w-full h-[400px] flex-none" key={index}>
                            <Image
            ...
            <div className="absolute z-40 -right-6 top-1/2 -translate-y-1/2" onClick={handleNextImg}>
                <button
                    type="button"
